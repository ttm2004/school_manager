...
requireAnyRole(['exam_manager','exam_staff']);
$pageTitle = 'Phong Khao thi';
...
<div class="container py-5" style="max-width:700px">
    <div class="text-center mb-5">
        <div style="width:80px;height:80px;background:#0d2d6b;border-radius:20px;display:inline-flex;align-items:center;justify-content:center;font-size:2.5rem;color:#fff;margin-bottom:20px">
            <i class="bi bi-clipboard-check-fill"></i>
        </div>
        <h3 class="fw-bold">Phong Khao thi</h3>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="alert alert-info mb-3">
                ...
                Module <strong>Phong Khao thi</strong> dang trong qua trinh phat trien.
                Cac chuc nang se duoc cap nhat trong phien ban tiep theo.
            </div>
            <h6 class="fw-bold mb-3">Chuc nang se co:</h6>
            <ul class="list-group list-group-flush">
<li class='list-group-item'><i class='bi bi-check-circle-fill text-success me-2'></i>Quan ly lich thi</li>
<li class='list-group-item'><i class='bi bi-check-circle-fill text-success me-2'></i>Ngan hang de thi</li>
<li class='list-group-item'><i class='bi bi-check-circle-fill text-success me-2'></i>Giam sat thi</li>
<li class='list-group-item'><i class='bi bi-check-circle-fill text-success me-2'></i>Nhap diem thi</li>
<li class='list-group-item'><i class='bi bi-check-circle-fill text-success me-2'></i>Bao cao ket qua thi</li>
            </ul>
        </div>
    </div>
