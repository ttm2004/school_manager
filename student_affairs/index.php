...
requireAnyRole(['student_affairs_manager','student_affairs_staff']);
$pageTitle = 'Phong Cong tac Sinh vien';
...
<div class="container py-5" style="max-width:700px">
    <div class="text-center mb-5">
        <div style="width:80px;height:80px;background:#dc3545;border-radius:20px;display:inline-flex;align-items:center;justify-content:center;font-size:2.5rem;color:#fff;margin-bottom:20px">
            <i class="bi bi-person-heart"></i>
        </div>
        <h3 class="fw-bold">Phong Cong tac Sinh vien</h3>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="alert alert-info mb-3">
                ...
                Module <strong>Phong Cong tac Sinh vien</strong> dang trong qua trinh phat trien.
                Cac chuc nang se duoc cap nhat trong phien ban tiep theo.
            </div>
            <h6 class="fw-bold mb-3">Chuc nang se co:</h6>
            <ul class="list-group list-group-flush">
<li class='list-group-item'><i class='bi bi-check-circle-fill text-success me-2'></i>Quan ly ky luat SV</li>
<li class='list-group-item'><i class='bi bi-check-circle-fill text-success me-2'></i>Hoc bong - Tro cap</li>
<li class='list-group-item'><i class='bi bi-check-circle-fill text-success me-2'></i>Hoat dong ngoai khoa</li>
<li class='list-group-item'><i class='bi bi-check-circle-fill text-success me-2'></i>Tu van hoc tap</li>
<li class='list-group-item'><i class='bi bi-check-circle-fill text-success me-2'></i>Xu ly don tu SV</li>
            </ul>
        </div>
    </div>
