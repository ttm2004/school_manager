...
<div class="card">
    ...
    <div class="table-responsive">
        <table class="table table-sm table-hover mb-0">
            <thead class="table-light"><tr><th>Ma SV</th><th>Ho ten</th><th>Khoa</th><th>Nganh</th><th>Lop</th><th>Trang thai</th><th>Nam nhap hoc</th></tr></thead>
            <tbody>
    ...
    <div class="card-footer d-flex justify-content-between align-items-center">
        ...
        <?php echo renderAcademicPagination($pag,http_build_query(['faculty_id'=>$filterFaculty,'status'=>$filterStatus,'q'=>$search])); ?>
    </div>
    <?php endif; ?>
    <?php endif; ?>
</div>
