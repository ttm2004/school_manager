...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'toggle') {
        $id = intval($_POST['id'] ?? 0);
        if ($id) {
            $conn->query("UPDATE admission_news SET status = IF(status='show','hide','show') WHERE id=$id");
...
<div class="admin-main">
    <div class="admin-topbar">
        <div class="d-flex align-items-center gap-3">
            ...
            <span class="admin-topbar-title">Tin Tuyển sinh</span>
        </div>
    </div>
    <div class="admin-content">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span><i class="bi bi-newspaper me-2"></i>Danh sách Tin Tuyển sinh (<?php echo $total; ?>)</span>
