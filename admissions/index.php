                        ...
                        <div class="form-section">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <select id="major" name="major" required>
                                        ...
                                        $sql = "SELECT * FROM majors WHERE status = 'active' ORDER BY name";
                                        $result = $conn->query($sql);
                                        while ($row = $result->fetch_assoc()) {
                                            echo "<option value='" . $row['id'] . "' data-code='" . $row['code'] . "'>" . $row['name'] . " (" . $row['code'] . ")</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select id="method" name="method" required>
                                        ...
                                        <?php
                                        // Lấy danh sách phương thức từ database
                                        $sql = "SELECT * FROM admission_methods WHERE status = 'active' ORDER BY priority";
                                        $result = $conn->query($sql);
                                        while ($row = $result->fetch_assoc()) {
                            ...
                            <div class="form-group">
                                ...
                                <select id="combination" name="combination" required>
                                    ...
                                    $sql = "SELECT * FROM subject_combinations ORDER BY code";
                                    $result = $conn->query($sql);
                                    while ($row = $result->fetch_assoc()) {
