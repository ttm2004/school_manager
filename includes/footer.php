        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center text-md-end">
                ...
                <small class="text-white-50">
                    <i class="bi bi-circle-fill me-1" style="color:#4ade80;font-size:.55rem;vertical-align:middle;"></i>
                    <strong style="color:#fff;"><?php echo number_format($__total); ?></strong> người đang trực tuyến
                    &nbsp;&bull;&nbsp; Thiết kế bởi Phòng Công nghệ Thông tin
                </small>
                <?php else: ?>
